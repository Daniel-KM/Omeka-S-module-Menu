...
class Breadcrumbs extends AbstractBlockLayout implements TemplateableBlockLayoutInterface
{
    ...
    public function form(
        ...
        return '<p>'
            . sprintf(
                $view->translate('This block uses the options set in the %ssite settings%s, unless you use the template of Omeka in the config of the block.'), // @translate
                '<a href="' . $view->url('admin/site/slug', ['action' => 'edit'], ['fragment' => 'site-settings'], true) . '">',
                '</a>'
            )
            . '</p>';
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block, $templateViewScript = self::PARTIAL_NAME)
    {
        ...
        $crumbOptions = $siteSetting('menu_breadcrumbs_crumbs') ?: [];
        ...
        $vars['separator'] = (string) $siteSetting('menu_breadcrumbs_separator');
